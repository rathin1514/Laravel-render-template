...
import { getSubscriptions } from "../../api_admin";
...
function AdminSubscriptions() {
    ...
    const handleCardClick = (subscriptionId) => {
        ...
        <>
            <div className="d-flex justify-content-between align-items-center my-3">
                <div className="d-flex">
                    <h1 className="mb-0">All Subscriptions</h1>
                </div>
            </div>
                        ...
                        <div key={sub.subscription_id} className="col-xl-4 col-md-6 col-sm-9 my-4 mx-auto">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    onClick={() => handleCardClick(sub.subscription_id)}
                                >
                                    More info
                                </button>
                            </div>
